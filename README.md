...
| [Рекомендация тарифа мобильной связи](tariff_mobile_recommendation) | Нужно построить модель для задачи классификации, которая выберет подходящий тариф. | *pandas*, *numpy*, *sklearn*, *collections* |
